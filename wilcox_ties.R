# When performing the differential splicing analysis (Fig5b), we notice two
# strata in the plot: the second stratum is related with ties when performing
# Wilcoxon as expected given the use of a non-parametric rank-based test
